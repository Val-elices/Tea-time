                        ...
                        <?php if (!$cart_is_empty) : ?>
                            <?php foreach ($woocommerce->cart->get_cart() as $cart_item_key => $cart_item) :
                                ...
                                <li>
                                    ...
                                    <div class="mkdf-item-info-holder">
										...
										<?php echo apply_filters('verdure_mikado_woo_cart_item_remove_link', sprintf('<a href="%s" class="remove" title="%s"><span class="icon-arrows-remove"></span></a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), esc_html__('Retirer cet article', 'verdure')), $cart_item_key); ?>
                                    </div>
                                </li>
                            <?php endforeach; ?>
                            <li class="mkdf-cart-bottom">
                                ...
                                <div class="mkdf-btn-holder clearfix">
                                    <a itemprop="url" href="<?php echo esc_url(wc_get_cart_url()); ?>" class="mkdf-view-cart"><?php esc_html_e('Voir le panier', 'verdure'); ?></a>
                                </div>
                            </li>
                        <?php else : ?>
                            <li class="mkdf-empty-cart"><?php esc_html_e('Aucun produit.', 'verdure'); ?></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
